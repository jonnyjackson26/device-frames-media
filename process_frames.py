...
def generate_index_file(output_root: Path, base_url: str = GITHUB_PAGES_BASE_URL):
    ...
    for template_path in template_paths:
        ...
        # Expected structure: {device-type}/{device-model}/{variant}
...
if __name__ == "__main__":
    ...
    had_changes_or_failures = find_and_process_frames(
        frames_input,
        frames_output
    )
